					...
					<div class="flex-relative" :style="{overflow: isExpanded ? 'visible' : 'hidden'}">
						<div ref="sectionList" class="section-list">
							...
							<div class="close-display">
								<div @click="changeIsExpanded" class="close-content">
...
<!--						<el-table-column label="操作">
			...
			<div class="float-left float-select">
				<div class="common-bank question-bank">热门企业题库</div>
				...
				<div class="sidebar-tags">
					...
					<a href="#" class="sidebar-mrb">
						<span class="sidebar-sp">
							<span class="sidebar-sp1">阿af里云</span>
							<span class="sidebar-sp2">1fdass88</span>
						</span>
					</a>
					<a href="#" class="sidebar-mrb">
						<span class="sidebar-sp">
...
.find-item .open-content img.more-svg {
	position: relative;
	top: 5px;
	max-height: 11px;
}
